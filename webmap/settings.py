...
LEAFLET_CONFIG = {
    ...
    'DEFAULT_ZOOM':14,
    'MIN_ZOOM':14,
    'SPATIAL_EXTENT':(-8.83,30.43,-8.92,30.52),
    'ATTRIBUTION_PREFIX':'Inpired by MAAZIZ, Master SGARNE',
    'TILES': [('Routes', 'https://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png', {'attribution': '&copy; Big eye', }),
